...
#define rotate_cw 0 //10              // goes high to activate rotator R (CW) rotation - pin 1 on Yaesu connector
#define rotate_ccw 0 //9             // goes high to activate rotator L (CCW) rotation - pin 2 on Yaesu connector
#define rotate_cw_ccw  0         // goes high for both CW and CCW rotation
#define rotate_cw_pwm 10 //0          // optional - PWM CW output - set to 0 to disable (must be PWM capable pin)
#define rotate_ccw_pwm 9 //0         // optional - PWM CCW output - set to 0 to disable (must be PWM capable pin)
...
#define rotate_up 0 //6               // goes high to activate rotator elevation up
#define rotate_down 0 //5             // goes high to activate rotator elevation down
#define rotate_up_or_down 0       // goes high when elevation up or down is activated
#define rotate_up_pwm 6           // optional - PWM UP output - set to 0 to disable (must be PWM capable pin)
#define rotate_down_pwm 5         // optional - PWM DOWN output - set to 0 to disable (must be PWM capable pin)
...
#define el_rotary_preset_pin1 A1                    // UP Encoder Pin
#define el_rotary_preset_pin2 A2                     // DOWN Encoder Pin
...
//Adafruit OLED 4 bit LCD pins
#define lcd_4_bit_rs_pin 6
#define lcd_4_bit_rw_pin 7
#define lcd_4_bit_enable_pin 8
#define lcd_4_bit_d4_pin 9
#define lcd_4_bit_d5_pin 10
#define lcd_4_bit_d6_pin 11
#define lcd_4_bit_d7_pin 12
