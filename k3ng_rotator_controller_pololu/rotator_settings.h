...
#define ANALOG_AZ_FULL_CCW 11
#define ANALOG_AZ_FULL_CW 926
...
#define AZ_INITIALLY_IN_SLOW_DOWN_PWM 64  // PWM value to start at if we're starting in the slow down zone (1 - 255)
...
#define SLOW_DOWN_BEFORE_TARGET_EL 20.0  // if slow down is enabled, slowdown will be activated within this many degrees of target azimuth
...
#define EL_INITIALLY_IN_SLOW_DOWN_PWM 64  // PWM value to start at if we're starting in the slow down zone (1 - 255)
...
#define AZIMUTH_TOLERANCE 2.0            // rotator will stop within X degrees when doing autorotation
#define ELEVATION_TOLERANCE 1.0 //1.0
...
#define I2C_LCD_COLOR WHITE            // default color of I2C LCD display, including Adafruit and Yourduino; some Yourduino may want this as LED_ON
...
#define PARK_AZIMUTH 180.0 * HEADING_MULTIPLIER      // replace the 0.0 with your park azimuth; azimuth is in raw degrees (i.e. on a 180 degree starting point rotator, 0 degrees = 360)
