...
void read_azimuth(byte force_read){
  ...
  if (1) {
   ...
   #ifdef FEATURE_LSM303_CALIBRATION
  ...
  #endif // FEATURE_LSM303_CALIBRATION
    //lsm.read();
...
void initialize_peripherals(){
  ...
  */
  ...
  compass.m_min = (LSM303::vector<int16_t>){+59, +19, -731};
  compass.m_max = (LSM303::vector<int16_t>){+909, +491, +14};
